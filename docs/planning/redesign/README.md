...
| 07 | `07-multi-output-units.md` | Principles & picker UI grammar locked (revised Apr 2026); implementation deferred |
...
- **Multi-output units:** discoverability glyph detail (fan-out badge in chain overview); unit-focused-view sub-out topology surfacing (file 07)
